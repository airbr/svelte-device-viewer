<script>	
	export let devices = document.getElementsByClassName("section-device");
	export let count = -1;
  ...
  function toggleDevice() {
	...
	count += 1
	devices[count].style.display = 'block';
	if (count === 12){
		count = -1;
	}
  }
...
<main>
	<button on:click={toggleDevice}>Device Viewer</button>
			...
			<div class="column col-12">
			  <div class="device device-iphone-x">
				<div class="device-frame">
					<img class="device-content" src="/flowers.avif">
